...
* Staining overlap (Giemsa stain positive)
...
```{r models}
without_essentiality <- glm(Founders ~ EmbryonicExpression+pLI+oe+RelativeChromosomalLocation+Acetylated+Methylated+GiemsaPositiveStain+OmimAnnotation, family="binomial", data=ds)
with_essentiality <- glm(Founders ~ Essential+EmbryonicExpression+pLI+oe+RelativeChromosomalLocation+Acetylated+Methylated+GiemsaPositiveStain+OmimAnnotation, family="binomial", data=ds)
```

### Logistic Regression Statistics: Without Essentiality

Model Statistics:
```{r print_models_without, echo=FALSE}
summary_without_essentiality <- summary(without_essentiality)
pvals_without_essentiality <- summary_without_essentiality$coeff[,4]
adj_pvals_without_essentiality <- p.adjust(pvals_without_essentiality)
print(summary_without_essentiality,digits=6)
print('Adjusted P-values')
print(adj_pvals_without_essentiality)
```
Log Odds:
```{r, echo=FALSE}
...
### Logistic Regression Statistics: With Essentiality
Model Statistics:
```{r print_models_with, echo=FALSE}
summary_with_essentiality <- summary(with_essentiality)
pvals_with_essentiality <- summary_with_essentiality$coeff[,4]
adj_pvals_with_essentiality <- p.adjust(pvals_with_essentiality)
print(summary_with_essentiality,digits=6)
print('Adjusted P-values')
print(adj_pvals_with_essentiality)
```
Log Odds:
```{r, echo=FALSE}
